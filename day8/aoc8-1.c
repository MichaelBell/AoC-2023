...
int main()
{
    ...
    const char* first_instr = "AAA ";
    const char* next_instr = first_instr;
    ...
    while (true) {
        ...
        while (true) {
            ...
            if (check_word(ptr, end, next_instr)) {
                //printf("%.*s\n", end - ptr, ptr);
                ptr = end;
                if (*ptr++ != ' ') fail();
                if (*ptr++ != '=') fail();
        ...
        next_instr = ptr;
        ptr = read_word(ptr);
        //printf("%.*s\n", ptr - next_instr, next_instr);
        if (check_word(next_instr, ptr, "ZZZ")) {
            break;
        }
        ++count;
    }
